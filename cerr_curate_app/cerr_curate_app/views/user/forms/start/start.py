...
TMPL8S = 'cerr_curate_app/user/forms/start/'
...
class StartForm(MultiForm):
    ...
    xmlfile = forms.FileField(widget=forms.FileInput(attrs={'class': 'form-control'}), required=False)
    start_meth = forms.ChoiceField(widget=MethodSelect, required=True, choices=[
